...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        example["query"] = example.get(self.prompt_key, prompt)
        
        if "multi_modal_data" in example:
            if "images" in example["multi_modal_data"]:
                example["images"] = example["multi_modal_data"]["images"]
            elif "videos" in example["multi_modal_data"]:
                example["videos"] = example["multi_modal_data"]["videos"]
